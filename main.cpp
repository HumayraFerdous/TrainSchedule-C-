                        ...
                        do
                        {
                            ...
                            if(choose7==1)
                            {
                                ...
                                else
                                {
                                    ...
                                    for(int j=0; j<h; j++)
                                    {
                                        cout<<endl<<"\tUser accounts: "<<j+1<<endl<<endl;
                                        dshow.ind(j);
                                        dshow.displaydata();
                    ...
                    if(flag==true)
                    {
                        ...
                        if(chois==1)
                        {
                            do
                            {
                                ...
                                cout<<"\n\tp for Passenger and e for Mail train: ";
                                cin>>cc;
                                if(cc=='p')
                                {
                                    int count1=0;
                                    ...
                                    {
                                        cout<<"\n-------------------------------------\n\n";
                                        cout<<"\t1.Show detail train schedule\n";
                                        cout<<"\t2.Reservation\n";
                                        cout<<"\t3.Cancellation\n";
                                        cout<<"\n-------------------------------------\n";
                                        cout<<"\n\tEnter User choice: ";
